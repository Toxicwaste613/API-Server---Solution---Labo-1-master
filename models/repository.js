...
class Repository {
    ...
    getAll(params = null) {
        ...
        if (params) {
            ...
            // todo sort
            //Reçu de l'assistance par un collègue
            if (sortKeys.length > 0) {
                if (searchKeys.length > 0) {
                    filteredAndSortedObjects = this.sortObj(filteredAndSortedObjects,sortKeys);
                }
                else {
                    filteredAndSortedObjects = this.sortObj(objectsList,sortKeys);
                }
            }
